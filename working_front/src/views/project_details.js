    ...
    <Fragment>
        ...
        <dl>
            ...
            <dt>Description of project</dt>
                ...
                <dd>- This initiative aims to address and enhance various aspects, including nutrition assistance, sustainability, financial planning, convenience hurdles, food education and meal preparation, the minimization of food waste, accessibility to information, promotion of healthy eating habits, diversification of meal options, bolstering mental well-being, and fostering environmental awareness.</dd>
                ...
                <dd>- Our target users are anyone who has moved to a new environment, starting new diets, dealing with dietary restrictions, people needing or wanting to improve their health through food, or those with limited resources. In essence, anyone who eats! They should care because managing food effectively directly impacts one's health, well-being, and financial stability. </dd>
                <dd>- Based on reports from WHO, “Around 2.3 billion people in the world (29.3%) were moderately or severely food insecure in 2021 – 350 million more compared to before the outbreak of the COVID‑19 pandemic.” The CDC states that In 2021, 5.9% of adults lived in families experiencing food insecurity in the past 30 days. Women were more likely to live in families experiencing food insecurity (6.5%) than men (5.2%). One last source is the FRAC who states Over 33.8 million Americans (10.2) lived in households that struggled against food insecurity, or lack of access to an affordable, nutritious diet. One in 26 (3.8 percent) of households in the U.S. experienced very low food security, a more severe form of food insecurity, where households report regularly skipping meals or reducing intake because they could not afford more food.</dd>
                <dd>- Our solution is an app or website that will take into account one's dietary needs, budget, location, and food plan to help find foods and recipes based on what they already have and what is available in the general area. Ideally there would be an SQL food database as backend - track calories, food groups, what diets/food plans they belong to, compound foods show ingredients. a Python system to act as go between from data to interface, and an app dev kit to manage the front end that hopefully produces a general interface that processes results for use. We are choosing to create an apple app based on our own convenience. Some of our database information would include meal prep time in a recipe table, green/yellow/red foods based on diet needs, Allergens (dairy-free, peanut-free, etc.), calories, diets and their corresponding requirements, as well as geography and “close” stores with inventory and prices</dd>
                <dd>- Many of these solutions don’t take into account what food you already have or what food is available around you in terms of stores, markets, food pantries, ect. Knowing what food you should be eating is one thing, managing it within a budget and where one can get it is another.</dd>
